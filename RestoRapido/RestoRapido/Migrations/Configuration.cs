namespace RestoRapido.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RestoRapido.Models.CRestoContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "RestoRapido.Models.CRestoContext";
        }

        protected override void Seed(RestoRapido.Models.CRestoContext Context)
        {
            //---------------------------------------------------------------------------------------------------------
            // UTILISATEURS
